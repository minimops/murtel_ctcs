...
from rgb_filter_model_training import main as rgb_filter_model_training

"""
Script that orchestrates:
1) Feature extraction (extraction.py),
2) Train-test splitting (train_test_splitting.py),
3) Model training (rgb_filter_model_training.py),
...
def main(
    ...
    # 4) Saving the Model
    print("\n=== Saving Model ===")
    model_path = f'{model}_model_{timestamp}.joblib'
